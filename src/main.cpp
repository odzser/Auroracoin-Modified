...
static unsigned int GetNextWorkRequiredMULTI(CBlockIndex* pindexLast, const CBlockHeader *pblock, int algo)
{
	unsigned int nProofOfWorkLimit = Params().ProofOfWorkLimit(algo).GetCompact();
...
unsigned int GetNextWorkRequired(CBlockIndex * pindexLast, const CBlockHeader * pblock, int algo){
